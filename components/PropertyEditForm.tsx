...
import { Fields } from "./PropertyAddForm";
...
export default function PropertyEditForm() {
  ...
  // ToDo: feeels like I am repeating myself
  const [fields, setFields] = useState<Omit<Fields, "images">>({
    type: "",
    name: "",
    description: "",
    location: {
  ...
  const handleChange = (
    ...
    if (name.includes(".")) {
      ...
      const outerKeyTyped = outerKey as "location" | "amenities" | "rates";

      setFields((prevFields) => ({
        ...prevFields,
        [outerKey]: {
          ...prevFields[outerKeyTyped],
          [innerKey]: value,
        },
      }));
    } else {
