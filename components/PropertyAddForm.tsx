...
export default function PropertyAddForm() {
  ...
  const handleChange = (
    ...
    if (name.includes(".")) {
      ...
      const outerKeyTyped = outerKey as
        | "location"
        | "amenities"
        | "rates"
        | "images";
  ...
  const handleAmenitiesChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    setFields((prevFields) => {
      ...
      const updatedAmenites = [...prevFields.amenities];
      ...
      return { ...prevFields, amenities: updatedAmenites };
    });
  };
  ...
  const handleImageChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    for (let i = 0; i < files.length; i++) {
      updatedImages.push(files[i].name);
    }
